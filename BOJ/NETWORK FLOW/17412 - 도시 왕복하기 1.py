'''
BOJ17412 - Round Trip 1 (https://www.acmicpc.net/problem/17412)

You are given a directed graph with N nodes and P edges.
Determine the number of distinct paths from vertex 1 to vertex 2.
There should be no common edges between paths.
'''
...
while True:
    ...
    while queue and parent[sink] == -1:
        ...
        for next_node in range(node_count):
            if graph[now_node][next_node] and capacity[now_node][next_node] > flow[now_node][next_node] and parent[next_node] == -1:
